...
// for (let i = 0; i < recipes.length; i++) {
//   const cardSearch = `<ul class="ingredients-search-list">
//     ${searchIngredients(recipes[i].ingredients)}
//       </ul>`;
//   containerSearch.innerHTML += cardSearch;
// }
...
//   ingredientsSearchList.forEach((element) => {
//     ingredientsearch += `<li class="search-ingredient text-search">
//                       ${element.ingredient}
//                     </li>`;
//   });
